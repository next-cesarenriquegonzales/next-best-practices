...
## Descripción
> Hay que explicar el nombre y una breve descripción de su objetivo (que se especificará más en siguientes puntos). En caso de duda una arquitectura soluciona varios problemas usando diferentes técnicas, y un proyecto normalmente tiene una o más arquitecturas válidas.
